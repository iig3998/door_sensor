...
#define CONFIG_WIFI_SSID "DomoticHouse"
#define CONFIG_WIFI_PASSWORD "D0m0t1cH0use"
#define CONFIG_NUMBER_ATTEMPTS 3
#define CONFIG_ESPNOW_WIFI_CHANNEL 7
#define CONFIG_RETRASMISSION_TIME_MS 50
